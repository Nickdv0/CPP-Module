...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/10 07:20:20 by nde-vant          #+#    #+#             */
/*   Updated: 2025/08/10 07:22:25 by nde-vant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void identify(Base& p)
{
	// Try to dynamic_cast to each type using references
	// If the cast fails, it will throw std::bad_cast exception
	try
	{
